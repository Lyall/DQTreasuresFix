...
public:
	...
	class FString                                 Name_0;                                            // 0x0208(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TMulticastInlineDelegate<void()>              OnSetImageTargetSucceeded;                         // 0x0220(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnSetImageTargetFailed;                            // 0x0230(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnImageTargetFound;                                // 0x0240(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnImageTargetLost;                                 // 0x0250(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FVector& LastTrackedLocation, struct FRotator& LastTrackedRotation, struct FVector& NewUnreliableLocation, struct FRotator& NewUnreliableRotation)> OnImageTargetUnreliableTracking;                   // 0x0260(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMagicLeapImageTrackerComponent, Name_0) == 0x000208, "Member 'UMagicLeapImageTrackerComponent::Name_0' has a wrong offset!");
