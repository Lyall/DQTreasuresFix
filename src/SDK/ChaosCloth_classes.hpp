...
static_assert(sizeof(UChaosClothConfig) == 0x000090, "Wrong size on UChaosClothConfig");
...
static_assert(offsetof(UChaosClothConfig, AreaStiffness) == 0x00004C, "Member 'UChaosClothConfig::AreaStiffness' has a wrong offset!");
static_assert(offsetof(UChaosClothConfig, VolumeStiffness) == 0x000050, "Member 'UChaosClothConfig::VolumeStiffness' has a wrong offset!");
static_assert(offsetof(UChaosClothConfig, StrainLimitingStiffness) == 0x000054, "Member 'UChaosClothConfig::StrainLimitingStiffness' has a wrong offset!");
...
static_assert(offsetof(UChaosClothConfig, DampingCoefficient) == 0x00006C, "Member 'UChaosClothConfig::DampingCoefficient' has a wrong offset!");
static_assert(offsetof(UChaosClothConfig, DragCoefficient) == 0x000070, "Member 'UChaosClothConfig::DragCoefficient' has a wrong offset!");
static_assert(offsetof(UChaosClothConfig, AnimDriveSpringStiffness) == 0x000074, "Member 'UChaosClothConfig::AnimDriveSpringStiffness' has a wrong offset!");
static_assert(offsetof(UChaosClothConfig, bUseBendingElements) == 0x000078, "Member 'UChaosClothConfig::bUseBendingElements' has a wrong offset!");
static_assert(offsetof(UChaosClothConfig, bUseTetrahedralConstraints) == 0x000079, "Member 'UChaosClothConfig::bUseTetrahedralConstraints' has a wrong offset!");
static_assert(offsetof(UChaosClothConfig, bUseThinShellVolumeConstraints) == 0x00007A, "Member 'UChaosClothConfig::bUseThinShellVolumeConstraints' has a wrong offset!");
static_assert(offsetof(UChaosClothConfig, bUseSelfCollisions) == 0x00007B, "Member 'UChaosClothConfig::bUseSelfCollisions' has a wrong offset!");
static_assert(offsetof(UChaosClothConfig, bUseContinuousCollisionDetection) == 0x00007C, "Member 'UChaosClothConfig::bUseContinuousCollisionDetection' has a wrong offset!");
static_assert(offsetof(UChaosClothConfig, LinearVelocityScale) == 0x000080, "Member 'UChaosClothConfig::LinearVelocityScale' has a wrong offset!");
static_assert(offsetof(UChaosClothConfig, AngularVelocityScale) == 0x00008C, "Member 'UChaosClothConfig::AngularVelocityScale' has a wrong offset!");
...
static_assert(sizeof(UChaosClothingSimulationInteractor) == 0x000048, "Wrong size on UChaosClothingSimulationInteractor");
