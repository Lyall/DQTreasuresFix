...
static_assert(offsetof(UMovieSceneSequence, bPlayableDirectly) == 0x00034A, "Member 'UMovieSceneSequence::bPlayableDirectly' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSequencePlayer) == 0x000890, "Wrong size on UMovieSceneSequencePlayer");
...
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackSettings) == 0x000490, "Member 'UMovieSceneSequencePlayer::PlaybackSettings' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, RootTemplateInstance) == 0x0004A8, "Member 'UMovieSceneSequencePlayer::RootTemplateInstance' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, NetSyncProps) == 0x000830, "Member 'UMovieSceneSequencePlayer::NetSyncProps' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackClient) == 0x000840, "Member 'UMovieSceneSequencePlayer::PlaybackClient' has a wrong offset!");
...
public:
	...
	struct FSoftObjectPath                        CustomClockSourcePath;                             // 0x0128(0x0018)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FMovieSceneMarkedFrame>         MarkedFrames;                                      // 0x0140(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieScene) == 0x000150, "Wrong size on UMovieScene");
...
static_assert(offsetof(UMovieScene, MarkedFrames) == 0x000140, "Member 'UMovieScene::MarkedFrames' has a wrong offset!");
...
{
public:
	class FName                                   FolderName;                                        // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UMovieSceneFolder*>              ChildFolders;                                      // 0x0038(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UMovieSceneTrack*>               ChildMasterTracks;                                 // 0x0048(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class FString>                         ChildObjectBindingStrings;                         // 0x0058(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UTestMovieSceneSubTrack) == 0x000080, "Wrong size on UTestMovieSceneSubTrack");
static_assert(offsetof(UTestMovieSceneSubTrack, SectionArray) == 0x000070, "Member 'UTestMovieSceneSubTrack::SectionArray' has a wrong offset!");
