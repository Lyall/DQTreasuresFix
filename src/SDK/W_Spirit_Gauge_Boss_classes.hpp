...
// WidgetBlueprintGeneratedClass W_Spirit_Gauge_Boss.W_Spirit_Gauge_Boss_C
// 0x0060 (0x0680 - 0x0620)
class UW_Spirit_Gauge_Boss_C final : public UUISpirit_Gauge
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"W_Spirit_Gauge_Boss_C">();
	}
	static class UW_Spirit_Gauge_Boss_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UW_Spirit_Gauge_Boss_C>();
	}
};
static_assert(alignof(UW_Spirit_Gauge_Boss_C) == 0x000010, "Wrong alignment on UW_Spirit_Gauge_Boss_C");
static_assert(sizeof(UW_Spirit_Gauge_Boss_C) == 0x000680, "Wrong size on UW_Spirit_Gauge_Boss_C");
static_assert(offsetof(UW_Spirit_Gauge_Boss_C, Gauge_Low_Change) == 0x000620, "Member 'UW_Spirit_Gauge_Boss_C::Gauge_Low_Change' has a wrong offset!");
static_assert(offsetof(UW_Spirit_Gauge_Boss_C, Gauge_Mid_Change) == 0x000628, "Member 'UW_Spirit_Gauge_Boss_C::Gauge_Mid_Change' has a wrong offset!");
static_assert(offsetof(UW_Spirit_Gauge_Boss_C, Gauge_All) == 0x000630, "Member 'UW_Spirit_Gauge_Boss_C::Gauge_All' has a wrong offset!");
static_assert(offsetof(UW_Spirit_Gauge_Boss_C, Gauge_Low) == 0x000638, "Member 'UW_Spirit_Gauge_Boss_C::Gauge_Low' has a wrong offset!");
static_assert(offsetof(UW_Spirit_Gauge_Boss_C, Gauge_Mid) == 0x000640, "Member 'UW_Spirit_Gauge_Boss_C::Gauge_Mid' has a wrong offset!");
static_assert(offsetof(UW_Spirit_Gauge_Boss_C, Gauge_Full) == 0x000648, "Member 'UW_Spirit_Gauge_Boss_C::Gauge_Full' has a wrong offset!");
static_assert(offsetof(UW_Spirit_Gauge_Boss_C, Out) == 0x000650, "Member 'UW_Spirit_Gauge_Boss_C::Out' has a wrong offset!");
static_assert(offsetof(UW_Spirit_Gauge_Boss_C, In) == 0x000658, "Member 'UW_Spirit_Gauge_Boss_C::In' has a wrong offset!");
static_assert(offsetof(UW_Spirit_Gauge_Boss_C, Face) == 0x000660, "Member 'UW_Spirit_Gauge_Boss_C::Face' has a wrong offset!");
static_assert(offsetof(UW_Spirit_Gauge_Boss_C, Gauge_Base) == 0x000668, "Member 'UW_Spirit_Gauge_Boss_C::Gauge_Base' has a wrong offset!");
static_assert(offsetof(UW_Spirit_Gauge_Boss_C, Gauge_Body) == 0x000670, "Member 'UW_Spirit_Gauge_Boss_C::Gauge_Body' has a wrong offset!");
static_assert(offsetof(UW_Spirit_Gauge_Boss_C, Gauge_Edge) == 0x000678, "Member 'UW_Spirit_Gauge_Boss_C::Gauge_Edge' has a wrong offset!");
