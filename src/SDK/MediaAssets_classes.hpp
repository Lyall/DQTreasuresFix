...
public:
	...
	uint8                                         Pad_708[0x1D8];                                    // 0x0708(0x01D8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMediaTexture) == 0x000190, "Wrong size on UMediaTexture");
static_assert(offsetof(UMediaTexture, AddressX) == 0x0000C0, "Member 'UMediaTexture::AddressX' has a wrong offset!");
static_assert(offsetof(UMediaTexture, AddressY) == 0x0000C1, "Member 'UMediaTexture::AddressY' has a wrong offset!");
static_assert(offsetof(UMediaTexture, AutoClear) == 0x0000C2, "Member 'UMediaTexture::AutoClear' has a wrong offset!");
static_assert(offsetof(UMediaTexture, ClearColor) == 0x0000C4, "Member 'UMediaTexture::ClearColor' has a wrong offset!");
static_assert(offsetof(UMediaTexture, EnableGenMips) == 0x0000D4, "Member 'UMediaTexture::EnableGenMips' has a wrong offset!");
static_assert(offsetof(UMediaTexture, NumMips) == 0x0000D5, "Member 'UMediaTexture::NumMips' has a wrong offset!");
static_assert(offsetof(UMediaTexture, MediaPlayer) == 0x0000D8, "Member 'UMediaTexture::MediaPlayer' has a wrong offset!");
