...
public:
	...
	TMulticastInlineDelegate<void(struct FMagicLeapTouchpadGesture& GestureData)> OnTouchpadGestureStart;                            // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FMagicLeapTouchpadGesture& GestureData)> OnTouchpadGestureContinue;                         // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(struct FMagicLeapTouchpadGesture& GestureData)> OnTouchpadGestureEnd;                              // 0x00E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMagicLeapTouchpadGesturesComponent) == 0x000148, "Wrong size on UMagicLeapTouchpadGesturesComponent");
static_assert(offsetof(UMagicLeapTouchpadGesturesComponent, OnTouchpadGestureStart) == 0x0000C0, "Member 'UMagicLeapTouchpadGesturesComponent::OnTouchpadGestureStart' has a wrong offset!");
static_assert(offsetof(UMagicLeapTouchpadGesturesComponent, OnTouchpadGestureContinue) == 0x0000D0, "Member 'UMagicLeapTouchpadGesturesComponent::OnTouchpadGestureContinue' has a wrong offset!");
static_assert(offsetof(UMagicLeapTouchpadGesturesComponent, OnTouchpadGestureEnd) == 0x0000E0, "Member 'UMagicLeapTouchpadGesturesComponent::OnTouchpadGestureEnd' has a wrong offset!");
