...
public:
	...
	TMulticastInlineDelegate<void(float EnvelopeValue)> OnAudioEnvelopeValue;                              // 0x0670(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USubmixEffectDynamicsProcessorPreset) == 0x000110, "Wrong size on USubmixEffectDynamicsProcessorPreset");
static_assert(offsetof(USubmixEffectDynamicsProcessorPreset, Settings) == 0x0000C0, "Member 'USubmixEffectDynamicsProcessorPreset::Settings' has a wrong offset!");
...
static_assert(sizeof(USubmixEffectReverbFastPreset) == 0x0000E0, "Wrong size on USubmixEffectReverbFastPreset");
static_assert(offsetof(USubmixEffectReverbFastPreset, Settings) == 0x0000A8, "Member 'USubmixEffectReverbFastPreset::Settings' has a wrong offset!");
