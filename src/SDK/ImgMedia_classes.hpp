...
{
public:
	struct FFrameRate                             FrameRateOverride;                                 // 0x0090(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UImgMediaSource) == 0x0000B8, "Wrong size on UImgMediaSource");
static_assert(offsetof(UImgMediaSource, FrameRateOverride) == 0x000090, "Member 'UImgMediaSource::FrameRateOverride' has a wrong offset!");
