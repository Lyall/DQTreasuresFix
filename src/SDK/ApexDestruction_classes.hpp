...
public:
	...
	TMulticastInlineDelegate<void(struct FVector& HitPoint, struct FVector& HitDirection)> OnActorFracture;                                   // 0x0230(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	TMulticastInlineDelegate<void(struct FVector& HitPoint, struct FVector& HitDirection)> OnComponentFracture;                               // 0x0680(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_690[0xA0];                                     // 0x0690(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UDestructibleComponent, OnComponentFracture) == 0x000680, "Member 'UDestructibleComponent::OnComponentFracture' has a wrong offset!");
...
static_assert(sizeof(UDestructibleMesh) == 0x000428, "Wrong size on UDestructibleMesh");
static_assert(offsetof(UDestructibleMesh, DefaultDestructibleParameters) == 0x000388, "Member 'UDestructibleMesh::DefaultDestructibleParameters' has a wrong offset!");
static_assert(offsetof(UDestructibleMesh, FractureEffects) == 0x000410, "Member 'UDestructibleMesh::FractureEffects' has a wrong offset!");
