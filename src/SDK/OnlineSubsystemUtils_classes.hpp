...
// 0x00A0 (0x1AD8 - 0x1A38)
class UIpConnection : public UNetConnection
{
public:
	uint8                                         Pad_1A38[0x50];                                    // 0x1A38(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SocketErrorDisconnectDelay;                        // 0x1A88(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1A8C[0x4C];                                    // 0x1A8C(0x004C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x001AD8, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x001A88, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(EInAppPurchaseState PurchaseStatus, struct FInAppPurchaseProductInfo& InAppPurchaseReceipts)> OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(EInAppPurchaseState PurchaseStatus, struct FInAppPurchaseProductInfo& InAppPurchaseReceipts)> OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	class FName                                   VoiceSubsystemNameOverride;                        // 0x0030(0x0008)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	TArray<struct FPIELoginSettingsInternal>      Logins;                                            // 0x0048(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	bool                                          bEnableRemovalRequests;                            // 0x0059(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_5A[0x6];                                       // 0x005A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FPartyReservation>              Reservations;                                      // 0x0060(0x0010)(ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UPartyBeaconState, bEnableRemovalRequests) == 0x000059, "Member 'UPartyBeaconState::bEnableRemovalRequests' has a wrong offset!");
