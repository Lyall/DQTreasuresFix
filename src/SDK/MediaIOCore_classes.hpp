...
static_assert(sizeof(UMediaCapture) == 0x000110, "Wrong size on UMediaCapture");
static_assert(offsetof(UMediaCapture, OnStateChanged) == 0x000030, "Member 'UMediaCapture::OnStateChanged' has a wrong offset!");
static_assert(offsetof(UMediaCapture, MediaOutput) == 0x000058, "Member 'UMediaCapture::MediaOutput' has a wrong offset!");
static_assert(offsetof(UMediaCapture, CapturingRenderTarget) == 0x000080, "Member 'UMediaCapture::CapturingRenderTarget' has a wrong offset!");
...
static_assert(sizeof(UFileMediaCapture) == 0x000180, "Wrong size on UFileMediaCapture");
