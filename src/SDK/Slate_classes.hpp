...
static_assert(sizeof(UButtonWidgetStyle) == 0x0002B0, "Wrong size on UButtonWidgetStyle");
...
static_assert(sizeof(UCheckBoxWidgetStyle) == 0x0005B8, "Wrong size on UCheckBoxWidgetStyle");
...
{
public:
	struct FComboBoxStyle                         ComboBoxStyle;                                     // 0x0038(0x03F0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboBoxWidgetStyle) == 0x000428, "Wrong size on UComboBoxWidgetStyle");
...
{
public:
	struct FComboButtonStyle                      ComboButtonStyle;                                  // 0x0038(0x03B8)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboButtonWidgetStyle) == 0x0003F0, "Wrong size on UComboButtonWidgetStyle");
...
static_assert(sizeof(UProgressWidgetStyle) == 0x0001D8, "Wrong size on UProgressWidgetStyle");
...
static_assert(sizeof(UScrollBarWidgetStyle) == 0x000508, "Wrong size on UScrollBarWidgetStyle");
...
static_assert(sizeof(UScrollBoxWidgetStyle) == 0x000260, "Wrong size on UScrollBoxWidgetStyle");
...
static_assert(sizeof(USpinBoxWidgetStyle) == 0x000320, "Wrong size on USpinBoxWidgetStyle");
