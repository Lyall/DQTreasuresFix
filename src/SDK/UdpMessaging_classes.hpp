...
public:
	...
	TArray<class FString>                         StaticEndpoints;                                   // 0x0060(0x0010)(Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<class FString>                         RemoteTunnelEndpoints;                             // 0x0098(0x0010)(Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UUdpMessagingSettings, bAutoRepair) == 0x000031, "Member 'UUdpMessagingSettings::bAutoRepair' has a wrong offset!");
static_assert(offsetof(UUdpMessagingSettings, bStopServiceWhenAppDeactivates) == 0x000032, "Member 'UUdpMessagingSettings::bStopServiceWhenAppDeactivates' has a wrong offset!");
