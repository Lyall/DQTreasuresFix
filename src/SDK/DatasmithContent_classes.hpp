...
static_assert(offsetof(ADatasmithAreaLightActor, LightType) == 0x000228, "Member 'ADatasmithAreaLightActor::LightType' has a wrong offset!");
static_assert(offsetof(ADatasmithAreaLightActor, LightShape) == 0x000229, "Member 'ADatasmithAreaLightActor::LightShape' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UTextureLightProfile>    IESTexture;                                        // 0x0060(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UDatasmithImportOptions, BaseOptions) == 0x00003C, "Member 'UDatasmithImportOptions::BaseOptions' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UMaterialInterface>      ParentMaterial;                                    // 0x0038(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TSoftObjectPtr<class USceneComponent>         AttachParent;                                      // 0x0078(0x0028)(ExportObject, InstancedReference, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
