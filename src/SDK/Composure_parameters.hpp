...
static_assert(offsetof(CompositingElementPass_SetPassEnabled, bEnabledIn) == 0x000000, "Member 'CompositingElementPass_SetPassEnabled::bEnabledIn' has a wrong offset!");
...
{
public:
	class UTextureRenderTarget2D*                 PickerTarget_0;                                    // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TArray<class UCompositingElementInput*>       ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<class UCompositingElementOutput*>      ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<class UCompositingElementTransform*>   ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(ComposureBlueprintLibrary_CopyCameraSettingsToSceneCapture) == 0x000010, "Wrong size on ComposureBlueprintLibrary_CopyCameraSettingsToSceneCapture");
...
{
public:
	class APlayerCameraManager*                   PlayerCameraManager_0;                             // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	class UTexture*                               DisplayTexture_0;                                  // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<class FString>                         BuffersToExport;                                   // 0x0010(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
