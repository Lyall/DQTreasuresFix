...
public:
	...
	TArray<struct FOpenColorIOColorSpace>         DesiredColorSpaces;                                // 0x0040(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UOpenColorIOColorTransform*>     ColorTransforms;                                   // 0x0050(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UOpenColorIOConfiguration) == 0x000060, "Wrong size on UOpenColorIOConfiguration");
...
static_assert(offsetof(UOpenColorIOConfiguration, ColorTransforms) == 0x000050, "Member 'UOpenColorIOConfiguration::ColorTransforms' has a wrong offset!");
