...
public:
	...
	TMap<class FString, struct FLevelSequenceObject> PossessedObjects;                                  // 0x0448(0x0050)(Deprecated, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	struct FSoftClassPath                         BurnInClass;                                       // 0x0038(0x0018)(Edit, BlueprintVisible, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(ALevelSequenceActor, AdditionalEventReceivers) == 0x000270, "Member 'ALevelSequenceActor::AdditionalEventReceivers' has a wrong offset!");
...
static_assert(sizeof(ULevelSequenceBurnIn) == 0x0002F8, "Wrong size on ULevelSequenceBurnIn");
static_assert(offsetof(ULevelSequenceBurnIn, FrameInformation) == 0x000238, "Member 'ULevelSequenceBurnIn::FrameInformation' has a wrong offset!");
static_assert(offsetof(ULevelSequenceBurnIn, LevelSequenceActor) == 0x0002F0, "Member 'ULevelSequenceBurnIn::LevelSequenceActor' has a wrong offset!");
...
static_assert(offsetof(ULevelSequencePlayer, OnCameraCut) == 0x000890, "Member 'ULevelSequencePlayer::OnCameraCut' has a wrong offset!");
