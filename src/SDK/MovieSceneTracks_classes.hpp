...
static_assert(offsetof(UMovieSceneAudioSection, bSuppressSubtitles) == 0x0002F8, "Member 'UMovieSceneAudioSection::bSuppressSubtitles' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bOverrideAttenuation) == 0x0002F9, "Member 'UMovieSceneAudioSection::bOverrideAttenuation' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraCutTrack) == 0x000078, "Wrong size on UMovieSceneCameraCutTrack");
static_assert(offsetof(UMovieSceneCameraCutTrack, bCanBlend) == 0x000060, "Member 'UMovieSceneCameraCutTrack::bCanBlend' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutTrack, Sections) == 0x000068, "Member 'UMovieSceneCameraCutTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneEventRepeaterSection) == 0x000110, "Wrong size on UMovieSceneEventRepeaterSection");
...
public:
	...
	uint8                                         Pad_E9[0x7];                                       // 0x00E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           LevelNames;                                        // 0x00F0(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
