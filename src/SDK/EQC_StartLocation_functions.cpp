...
#include "EQC_StartLocation_classes.hpp"
#include "EQC_StartLocation_parameters.hpp"
...
void UEQC_StartLocation_C::ProvideSingleLocation(class UObject* QuerierObject, class AActor* QuerierActor, struct FVector* ResultingLocation) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EQC_StartLocation_C", "ProvideSingleLocation");

	Params::EQC_StartLocation_C_ProvideSingleLocation Parms{};
