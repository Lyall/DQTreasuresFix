...
static_assert(sizeof(ULiveLinkSubjectSettings) == 0x000060, "Wrong size on ULiveLinkSubjectSettings");
...
static_assert(sizeof(ULiveLinkVirtualSubject) == 0x0000E0, "Wrong size on ULiveLinkVirtualSubject");
