...
public:
	...
	uint8                                         Pad_334[0xA4];                                     // 0x0334(0x00A4)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AMagicLeapSharedWorldGameMode) == 0x0003E0, "Wrong size on AMagicLeapSharedWorldGameMode");
static_assert(offsetof(AMagicLeapSharedWorldGameMode, SharedWorldData) == 0x000310, "Member 'AMagicLeapSharedWorldGameMode::SharedWorldData' has a wrong offset!");
static_assert(offsetof(AMagicLeapSharedWorldGameMode, OnNewLocalDataFromClients) == 0x000320, "Member 'AMagicLeapSharedWorldGameMode::OnNewLocalDataFromClients' has a wrong offset!");
static_assert(offsetof(AMagicLeapSharedWorldGameMode, PinSelectionConfidenceThreshold) == 0x000330, "Member 'AMagicLeapSharedWorldGameMode::PinSelectionConfidenceThreshold' has a wrong offset!");
static_assert(offsetof(AMagicLeapSharedWorldGameMode, ChosenOne) == 0x0003D8, "Member 'AMagicLeapSharedWorldGameMode::ChosenOne' has a wrong offset!");
