...
static_assert(sizeof(UInteractiveToolPropertySet) == 0x000058, "Wrong size on UInteractiveToolPropertySet");
static_assert(offsetof(UInteractiveToolPropertySet, CachedProperties) == 0x000048, "Member 'UInteractiveToolPropertySet::CachedProperties' has a wrong offset!");
static_assert(offsetof(UInteractiveToolPropertySet, bIsPropertySetEnabled) == 0x000050, "Member 'UInteractiveToolPropertySet::bIsPropertySetEnabled' has a wrong offset!");
...
static_assert(sizeof(UBrushBaseProperties) == 0x000070, "Wrong size on UBrushBaseProperties");
static_assert(offsetof(UBrushBaseProperties, BrushSize) == 0x000058, "Member 'UBrushBaseProperties::BrushSize' has a wrong offset!");
static_assert(offsetof(UBrushBaseProperties, bSpecifyRadius) == 0x00005C, "Member 'UBrushBaseProperties::bSpecifyRadius' has a wrong offset!");
static_assert(offsetof(UBrushBaseProperties, BrushRadius) == 0x000060, "Member 'UBrushBaseProperties::BrushRadius' has a wrong offset!");
static_assert(offsetof(UBrushBaseProperties, BrushStrength) == 0x000064, "Member 'UBrushBaseProperties::BrushStrength' has a wrong offset!");
static_assert(offsetof(UBrushBaseProperties, BrushFalloffAmount) == 0x000068, "Member 'UBrushBaseProperties::BrushFalloffAmount' has a wrong offset!");
static_assert(offsetof(UBrushBaseProperties, bShowStrength) == 0x00006C, "Member 'UBrushBaseProperties::bShowStrength' has a wrong offset!");
static_assert(offsetof(UBrushBaseProperties, bShowFalloff) == 0x00006D, "Member 'UBrushBaseProperties::bShowFalloff' has a wrong offset!");
...
public:
	...
	struct FBrushStampData                        LastBrushStamp;                                    // 0x00D4(0x00A8)(NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UBaseBrushTool, LastBrushStamp) == 0x0000D4, "Member 'UBaseBrushTool::LastBrushStamp' has a wrong offset!");
...
static_assert(offsetof(UBrushStampIndicator, bDrawFalloffCircle) == 0x000062, "Member 'UBrushStampIndicator::bDrawFalloffCircle' has a wrong offset!");
...
{
public:
	struct FLinearColor                           Color;                                             // 0x0418(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HoverSizeMultiplier;                               // 0x0428(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PixelHitDistanceThreshold;                         // 0x042C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGizmoBaseComponent) == 0x000440, "Wrong size on UGizmoBaseComponent");
static_assert(offsetof(UGizmoBaseComponent, Color) == 0x000418, "Member 'UGizmoBaseComponent::Color' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, HoverSizeMultiplier) == 0x000428, "Member 'UGizmoBaseComponent::HoverSizeMultiplier' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, PixelHitDistanceThreshold) == 0x00042C, "Member 'UGizmoBaseComponent::PixelHitDistanceThreshold' has a wrong offset!");
...
{
public:
	struct FVector                                Direction;                                         // 0x0438(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Gap;                                               // 0x0444(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         Thickness;                                         // 0x044C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGizmoArrowComponent) == 0x000460, "Wrong size on UGizmoArrowComponent");
static_assert(offsetof(UGizmoArrowComponent, Direction) == 0x000438, "Member 'UGizmoArrowComponent::Direction' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Gap) == 0x000444, "Member 'UGizmoArrowComponent::Gap' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Length) == 0x000448, "Member 'UGizmoArrowComponent::Length' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Thickness) == 0x00044C, "Member 'UGizmoArrowComponent::Thickness' has a wrong offset!");
...
{
public:
	struct FVector                                Origin;                                            // 0x0438(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_444[0xC];                                      // 0x0444(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	struct FQuat                                  Rotation;                                          // 0x0450(0x0010)(Edit, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FVector                                Dimensions;                                        // 0x0460(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LineThickness;                                     // 0x046C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bRemoveHiddenLines;                                // 0x0470(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableAxisFlip;                                   // 0x0471(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGizmoBoxComponent) == 0x000480, "Wrong size on UGizmoBoxComponent");
static_assert(offsetof(UGizmoBoxComponent, Origin) == 0x000438, "Member 'UGizmoBoxComponent::Origin' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, Rotation) == 0x000450, "Member 'UGizmoBoxComponent::Rotation' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, Dimensions) == 0x000460, "Member 'UGizmoBoxComponent::Dimensions' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, LineThickness) == 0x00046C, "Member 'UGizmoBoxComponent::LineThickness' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, bRemoveHiddenLines) == 0x000470, "Member 'UGizmoBoxComponent::bRemoveHiddenLines' has a wrong offset!");
static_assert(offsetof(UGizmoBoxComponent, bEnableAxisFlip) == 0x000471, "Member 'UGizmoBoxComponent::bEnableAxisFlip' has a wrong offset!");
...
{
public:
	struct FVector                                Normal;                                            // 0x0438(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Radius;                                            // 0x0444(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Thickness;                                         // 0x0448(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumSides;                                          // 0x044C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bViewAligned;                                      // 0x0450(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOnlyAllowFrontFacingHits;                         // 0x0451(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_452[0xE];                                      // 0x0452(0x000E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGizmoCircleComponent) == 0x000460, "Wrong size on UGizmoCircleComponent");
static_assert(offsetof(UGizmoCircleComponent, Normal) == 0x000438, "Member 'UGizmoCircleComponent::Normal' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, Radius) == 0x000444, "Member 'UGizmoCircleComponent::Radius' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, Thickness) == 0x000448, "Member 'UGizmoCircleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, NumSides) == 0x00044C, "Member 'UGizmoCircleComponent::NumSides' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bViewAligned) == 0x000450, "Member 'UGizmoCircleComponent::bViewAligned' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bOnlyAllowFrontFacingHits) == 0x000451, "Member 'UGizmoCircleComponent::bOnlyAllowFrontFacingHits' has a wrong offset!");
...
public:
	struct FVector                                Normal;                                            // 0x0438(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HandleSize;                                        // 0x0444(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Thickness;                                         // 0x0448(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                Direction;                                         // 0x044C(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bImageScale;                                       // 0x045C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGizmoLineHandleComponent) == 0x000460, "Wrong size on UGizmoLineHandleComponent");
static_assert(offsetof(UGizmoLineHandleComponent, Normal) == 0x000438, "Member 'UGizmoLineHandleComponent::Normal' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, HandleSize) == 0x000444, "Member 'UGizmoLineHandleComponent::HandleSize' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Thickness) == 0x000448, "Member 'UGizmoLineHandleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Direction) == 0x00044C, "Member 'UGizmoLineHandleComponent::Direction' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Length) == 0x000458, "Member 'UGizmoLineHandleComponent::Length' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, bImageScale) == 0x00045C, "Member 'UGizmoLineHandleComponent::bImageScale' has a wrong offset!");
...
{
public:
	struct FVector                                DirectionX;                                        // 0x0438(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                DirectionY;                                        // 0x0444(0x000C)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OffsetX;                                           // 0x0450(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         OffsetY;                                           // 0x0454(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LengthX;                                           // 0x0458(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LengthY;                                           // 0x045C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         SegmentFlags;                                      // 0x0464(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGizmoRectangleComponent) == 0x000470, "Wrong size on UGizmoRectangleComponent");
static_assert(offsetof(UGizmoRectangleComponent, DirectionX) == 0x000438, "Member 'UGizmoRectangleComponent::DirectionX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, DirectionY) == 0x000444, "Member 'UGizmoRectangleComponent::DirectionY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, OffsetX) == 0x000450, "Member 'UGizmoRectangleComponent::OffsetX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, OffsetY) == 0x000454, "Member 'UGizmoRectangleComponent::OffsetY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, LengthX) == 0x000458, "Member 'UGizmoRectangleComponent::LengthX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, LengthY) == 0x00045C, "Member 'UGizmoRectangleComponent::LengthY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, Thickness) == 0x000460, "Member 'UGizmoRectangleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, SegmentFlags) == 0x000464, "Member 'UGizmoRectangleComponent::SegmentFlags' has a wrong offset!");
...
public:
	...
	TSoftClassPtr<class UClass>                   ToolManagerClass;                                  // 0x0078(0x0028)(Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UInteractiveToolsContext) == 0x0000A0, "Wrong size on UInteractiveToolsContext");
...
static_assert(sizeof(UKeyAsModifierInputBehavior) == 0x000120, "Wrong size on UKeyAsModifierInputBehavior");
...
static_assert(sizeof(UGizmoAxisRotationParameterSource) == 0x0000D0, "Wrong size on UGizmoAxisRotationParameterSource");
static_assert(offsetof(UGizmoAxisRotationParameterSource, AxisSource) == 0x000050, "Member 'UGizmoAxisRotationParameterSource::AxisSource' has a wrong offset!");
static_assert(offsetof(UGizmoAxisRotationParameterSource, TransformSource) == 0x000060, "Member 'UGizmoAxisRotationParameterSource::TransformSource' has a wrong offset!");
static_assert(offsetof(UGizmoAxisRotationParameterSource, Angle) == 0x000070, "Member 'UGizmoAxisRotationParameterSource::Angle' has a wrong offset!");
static_assert(offsetof(UGizmoAxisRotationParameterSource, LastChange) == 0x000074, "Member 'UGizmoAxisRotationParameterSource::LastChange' has a wrong offset!");
static_assert(offsetof(UGizmoAxisRotationParameterSource, CurRotationAxis) == 0x00007C, "Member 'UGizmoAxisRotationParameterSource::CurRotationAxis' has a wrong offset!");
static_assert(offsetof(UGizmoAxisRotationParameterSource, CurRotationOrigin) == 0x000088, "Member 'UGizmoAxisRotationParameterSource::CurRotationOrigin' has a wrong offset!");
static_assert(offsetof(UGizmoAxisRotationParameterSource, InitialTransform) == 0x0000A0, "Member 'UGizmoAxisRotationParameterSource::InitialTransform' has a wrong offset!");
...
{
public:
	TArray<int32>                                 Vertices;                                          // 0x0048(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<int32>                                 Edges;                                             // 0x0058(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<int32>                                 Faces;                                             // 0x0068(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<int32>                                 Groups;                                            // 0x0078(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	EToolContextCoordinateSystem                  CurrentCoordinateSystem;                           // 0x0054(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTransformGizmo) == 0x000190, "Wrong size on UTransformGizmo");
...
static_assert(offsetof(UTransformGizmo, bUseContextCoordinateSystem) == 0x000051, "Member 'UTransformGizmo::bUseContextCoordinateSystem' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, CurrentCoordinateSystem) == 0x000054, "Member 'UTransformGizmo::CurrentCoordinateSystem' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, ActiveComponents) == 0x0000F0, "Member 'UTransformGizmo::ActiveComponents' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, NonuniformScaleComponents) == 0x000100, "Member 'UTransformGizmo::NonuniformScaleComponents' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, ActiveGizmos) == 0x000110, "Member 'UTransformGizmo::ActiveGizmos' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, CameraAxisSource) == 0x000130, "Member 'UTransformGizmo::CameraAxisSource' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, AxisXSource) == 0x000138, "Member 'UTransformGizmo::AxisXSource' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, AxisYSource) == 0x000140, "Member 'UTransformGizmo::AxisYSource' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, AxisZSource) == 0x000148, "Member 'UTransformGizmo::AxisZSource' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, UnitAxisXSource) == 0x000150, "Member 'UTransformGizmo::UnitAxisXSource' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, UnitAxisYSource) == 0x000158, "Member 'UTransformGizmo::UnitAxisYSource' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, UnitAxisZSource) == 0x000160, "Member 'UTransformGizmo::UnitAxisZSource' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, StateTarget) == 0x000168, "Member 'UTransformGizmo::StateTarget' has a wrong offset!");
static_assert(offsetof(UTransformGizmo, ScaledTransformSource) == 0x000170, "Member 'UTransformGizmo::ScaledTransformSource' has a wrong offset!");
