...
static_assert(sizeof(UMovieSceneGeometryCollectionTrack) == 0x000070, "Wrong size on UMovieSceneGeometryCollectionTrack");
static_assert(offsetof(UMovieSceneGeometryCollectionTrack, AnimationSections) == 0x000060, "Member 'UMovieSceneGeometryCollectionTrack::AnimationSections' has a wrong offset!");
