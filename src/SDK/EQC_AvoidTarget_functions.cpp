...
#include "EQC_AvoidTarget_classes.hpp"
#include "EQC_AvoidTarget_parameters.hpp"
...
void UEQC_AvoidTarget_C::ProvideSingleLocation(class UObject* QuerierObject, class AActor* QuerierActor, struct FVector* ResultingLocation) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EQC_AvoidTarget_C", "ProvideSingleLocation");

	Params::EQC_AvoidTarget_C_ProvideSingleLocation Parms{};
